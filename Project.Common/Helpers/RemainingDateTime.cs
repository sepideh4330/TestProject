...
namespace Project.Common.Helpers
{
    public static class RemainingDateTime
    {
        ...
        public static string Calculate(DateTimeOffset dateTime)
        {
            var timeSpan = DateTimeOffset.UtcNow.IranStandardTimeNow() - dateTime;
            var ts = new TimeSpan(DateTimeOffset.UtcNow.IranStandardTimeNow().Ticks - dateTime.Ticks);
